    ...
    return `
        <div class="card">
            ...
            <div class="card-info">
                ...
                <button class="btn-main btn-agendar" data-nome="${clinica.nome}">
                    Agendar consulta <i class="fa-solid fa-arrow-right"></i>
                </button>

                <div class="btn-group">
                    <a href="../../pages/dashboard/contato.html" class="btn-secondary">
                        Entre em contato <i class="fa-solid fa-envelope"></i>
                    </a>
                    <a href="../../pages/dashboard/localização.html" class="btn-secondary">
...
function redirecionarAgendamento() {
  document.addEventListener("click", function (e) {
    const botao = e.target.closest(".btn-agendar");
    if (botao) {
      const nome = botao.getAttribute("data-nome");
      const url = "../../pages/dashboard/agendamento.html?clinica=" + encodeURIComponent(nome);
